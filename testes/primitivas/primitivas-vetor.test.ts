...
describe('Primitivas de vetor', () => {
    ...
    describe('encaixar()', () => {
        it('Inserindo novo elemento', async () => {
            let vetor = [1, 2, 3]
            await primitivasVetor.encaixar.implementacao(interpretador, vetor, 2, 0, 10);
        ...
        it('Apenas um parâmetro', async () => {
            ...
            const resultado = await primitivasVetor.encaixar.implementacao(interpretador, vetor, 1);
