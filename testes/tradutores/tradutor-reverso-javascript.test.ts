...
describe('Tradutor Reverso JavaScript -> Delégua', () => {
    ...
    describe('Código', () => {
        ...
        it('comparacao de valores -> igualdade', async () => {
        ...
        it('trim/trimStart/trimEnd -> aparar/apararInicio/apararFim', async () => {
            const codigo = `
            let a = '  abc   '
            let b = '  abc'
            let c = 'abc   '
        ...
        it('array - vetor - com valores', async () => {
        ...
        it('const -> const/constante', async () => {
            const codigo = `const a = 1`;
        ...
        it('function -> funcao sem parametro', async () => {
        ...
        it('function -> funcao com parametro', async () => {
        ...
        it('function -> funcao com retorno vazio', async () => {
        ...
        it('function -> funcao com retorno de variavel', async () => {
        ...
        it('function -> funcao com retorno de soma valores', async () => {
        ...
        it('function -> chamada de função', async () => {
        ...
        it('arrow function -> função seta', async () => {
        ...
        it('do while -> fazer enquanto', async () => {
            const codigo = `
                let result = '';
                let i = 0;                
                do {
        ...
        it('if/true/false -> se/verdadeiro/falso', async () => {
            const codigo = `             
                if(true){
        ...
        it('if/else if/else -> se/senao se/senao', async () => {
            const codigo = `
                let i = 1;                
                if(i == 1){
                    console.log(\'i é igual a 1\')
        ...
        it('try/catch/finally -> tente/pegue/finalmente', async () => {
            const codigo = `                
                try {
                    console.log(\'Teste1\')
                } catch (erro){
