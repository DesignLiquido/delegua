...
- A língua materna é substancialmente mais eficiente para expressão em passos lógicos, largamente documentada no meio acadêmico;
- Apenas considerando o Brasil, 5% de toda a população fala inglês em algum nível, seja ele elementar, intermediário ou fluente, com apenas 1% sendo efetivamente fluente. Aqui consideramos "fluência" como a dominância de 10000 palavras em inglês, além de plena capacidade de leitura, escrita e conversação;
