...
O interpretador com depuração de Delégua herda do interpretador base, mas a lógica é mais complexa para suportar os comandos e funcionalidades de mecanismos de depuração, que são:
