...
export function carregarBibliotecasGlobais(pilhaEscoposExecucao: PilhaEscoposExecucaoInterface) {
    ...
    pilhaEscoposExecucao.definirVariavel(
        'algum',
        new FuncaoPadrao(2, bibliotecaGlobal.algum)
    );
    ...
    pilhaEscoposExecucao.definirVariavel(
        'inteiro',
        new FuncaoPadrao(1, bibliotecaGlobal.inteiro)
    );

    pilhaEscoposExecucao.definirVariavel(
        'mapear',
        new FuncaoPadrao(2, bibliotecaGlobal.mapear)
    );

    pilhaEscoposExecucao.definirVariavel(
        'ordenar',
        new FuncaoPadrao(1, bibliotecaGlobal.ordenar)
    );
    ...
    pilhaEscoposExecucao.definirVariavel(
        'real',
        new FuncaoPadrao(1, bibliotecaGlobal.real)
    );

    pilhaEscoposExecucao.definirVariavel(
        'reduzir',
        new FuncaoPadrao(3, bibliotecaGlobal.reduzir)
    );

    pilhaEscoposExecucao.definirVariavel(
        'tamanho',
        new FuncaoPadrao(1, bibliotecaGlobal.tamanho)
    );

    pilhaEscoposExecucao.definirVariavel(
        'texto',
        new FuncaoPadrao(1, bibliotecaGlobal.texto)
    );

    pilhaEscoposExecucao.definirVariavel(
        'todos', new FuncaoPadrao(2, bibliotecaGlobal.todosEmCondicao)
    );
