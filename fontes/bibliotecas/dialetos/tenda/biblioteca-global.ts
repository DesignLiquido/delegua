...
export default function carregarBibliotecaGlobalTenda(
    ...
    globals.definirVariavel('Saída', {
        exiba: new FuncaoPadrao(1, function (_: any, texto: any) {
            const valor = texto !== null && texto !== undefined && texto.hasOwnProperty('valor') ? texto.valor : texto;
            interpretador.funcaoDeRetorno(valor !== null && valor !== undefined ? String(valor) : 'nulo');
        }),
        ...
        leia: new FuncaoPadrao(1, function (_: any, mensagem: any) {
            const msg = mensagem !== null && mensagem !== undefined && mensagem.hasOwnProperty('valor') ? mensagem.valor : mensagem;
    ...
    globals.definirVariavel('Lista', {
        tamanho: new FuncaoPadrao(1, function (_: any, lista: any) {
            const v = lista !== null && lista !== undefined && lista.hasOwnProperty('valor') ? lista.valor : lista;
            return v.length;
        }),
        insira: new FuncaoPadrao(2, function (_: any, lista: any, item: any) {
            const v = lista !== null && lista !== undefined && lista.hasOwnProperty('valor') ? lista.valor : lista;
            const i = item !== null && item !== undefined && item.hasOwnProperty('valor') ? item.valor : item;
            v.push(i);
        }),
        ...
        remova_por_índice: new FuncaoPadrao(2, function (_: any, lista: any, índice: any) {
            const v = lista !== null && lista !== undefined && lista.hasOwnProperty('valor') ? lista.valor : lista;
            const i = índice !== null && índice !== undefined && índice.hasOwnProperty('valor') ? índice.valor : índice;
            v.splice(i, 1);
        }),
        ...
        fatia: new FuncaoPadrao(3, function (_: any, lista: any, início: any, fim: any) {
            const v = lista !== null && lista !== undefined && lista.hasOwnProperty('valor') ? lista.valor : lista;
            const ini = início !== null && início !== undefined && início.hasOwnProperty('valor') ? início.valor : início;
            const f = fim !== null && fim !== undefined && fim.hasOwnProperty('valor') ? fim.valor : fim;
        ...
        de_texto: new FuncaoPadrao(1, function (_: any, texto: any) {
            const t = texto !== null && texto !== undefined && texto.hasOwnProperty('valor') ? texto.valor : texto;
            return t.split('');
        }),
    ...
    globals.definirVariavel('Matemática', {
        ...
        potência: new FuncaoPadrao(2, function (_: any, base: any, expoente: any) {
            const b = base !== null && base !== undefined && base.hasOwnProperty('valor') ? base.valor : base;
            const e = expoente !== null && expoente !== undefined && expoente.hasOwnProperty('valor') ? expoente.valor : expoente;
            return Math.pow(b, e);
        }),
    ...
    globals.definirVariavel('Texto', {
        ...
        para_lista: new FuncaoPadrao(2, function (_: any, t: any, sep: any) {
            const v = t !== null && t !== undefined && t.hasOwnProperty('valor') ? t.valor : t;
            const s = sep !== null && sep !== undefined && sep.hasOwnProperty('valor') ? sep.valor : sep;
            return v.split(s ?? '');
        }),
        ...
        contém: new FuncaoPadrao(2, function (_: any, t: any, sub: any) {
            const v = t !== null && t !== undefined && t.hasOwnProperty('valor') ? t.valor : t;
            const s = sub !== null && sub !== undefined && sub.hasOwnProperty('valor') ? sub.valor : sub;
            return v.includes(s);
        }),
        começa_com: new FuncaoPadrao(2, function (_: any, t: any, prefixo: any) {
            const v = t !== null && t !== undefined && t.hasOwnProperty('valor') ? t.valor : t;
            const p = prefixo !== null && prefixo !== undefined && prefixo.hasOwnProperty('valor') ? prefixo.valor : prefixo;
            return v.startsWith(p);
        }),
        termina_com: new FuncaoPadrao(2, function (_: any, t: any, sufixo: any) {
            const v = t !== null && t !== undefined && t.hasOwnProperty('valor') ? t.valor : t;
            const s = sufixo !== null && sufixo !== undefined && sufixo.hasOwnProperty('valor') ? sufixo.valor : sufixo;
            return v.endsWith(s);
        }),
        ...
        substitua: new FuncaoPadrao(3, function (_: any, t: any, busca: any, rep: any) {
            const v = t !== null && t !== undefined && t.hasOwnProperty('valor') ? t.valor : t;
            const b = busca !== null && busca !== undefined && busca.hasOwnProperty('valor') ? busca.valor : busca;
            const r = rep !== null && rep !== undefined && rep.hasOwnProperty('valor') ? rep.valor : rep;
    ...
    globals.definirVariavel('Data', {
        ...
        para_iso: new FuncaoPadrao(1, function (_: any, data: any) {
            const v = data !== null && data !== undefined && data.hasOwnProperty('valor') ? data.valor : data;
        ...
        de_iso: new FuncaoPadrao(1, function (_: any, iso: any) {
            const v = iso !== null && iso !== undefined && iso.hasOwnProperty('valor') ? iso.valor : iso;
            return new Date(v).getTime();
        }),
        ...
        com_região: new FuncaoPadrao(2, function (_: any, data: any, região: any) {
            const d = data !== null && data !== undefined && data.hasOwnProperty('valor') ? data.valor : data;
            const r = região !== null && região !== undefined && região.hasOwnProperty('valor') ? região.valor : região;
