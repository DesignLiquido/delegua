...
export default {
    aparar: { 
        tipoRetorno: 'texto',
        implementacao: (interpretador: VisitanteComumInterface, texto: string): Promise<string> => Promise.resolve(texto.trim())
    },
    apararFim: { 
        tipoRetorno: 'texto',
        implementacao: (interpretador: VisitanteComumInterface, texto: string): Promise<string> =>
    ...
    fatiar: {
        tipoRetorno: 'texto',
        implementacao: (interpretador: VisitanteComumInterface, texto: string, inicio: number, fim: number): Promise<string> =>
            Promise.resolve(texto.slice(inicio, fim))
    },
    inclui: {
        tipoRetorno: 'texto',
        implementacao: (interpretador: VisitanteComumInterface, texto: string, elemento: any): Promise<boolean> =>
    ...
    tamanho: {
        tipoRetorno: 'número',
        implementacao: (interpretador: VisitanteComumInterface, texto: string): Promise<number> => Promise.resolve(texto.length)
    }
