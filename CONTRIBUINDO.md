...
Qualquer pessoa pode sugerir melhoramentos para a linguagem ou correções de _bugs_. Uma recomendação é [abrir uma _issue_ no GitHub antes](https://github.com/DesignLiquido/delegua/issues/new/choose), para colher a opinião da comunidade e evitar rejeições de contribuições. 
...
O ambiente em que executamos é o Node.js que, basicamente, executa código JavaScript sem capacidades de navegadores de internet. Ou seja, se você tem conhecimento em JavaScript básico, é um primeiro passo para poder colaborar conosco. 

Por padrão, o Node.js vem com o NPM instalado, mas não o usamos. Usamos o Yarn, mais moderno e rápido. Você pode instalar o Yarn usando o comando abaixo (já tendo o NPM instalado):
...
Para os fontes, usamos [TypeScript](https://www.typescriptlang.org/) (versão mais recente), o que não é muito diferente do JavaScript. Normalmente desenvolvemos em Visual Studio Code, e, ao abrir o projeto nele, já temos as configurações para depurar (debugar) Delégua. Outros editores podem ser usados, mas não temos arquivos de suporte a todos eles.
